...
unlocked to sign the Presidentielcoin-Qt.app bundle.
...
allowing somebody to distribute a Presidentielcoin-Qt.app or presidentielcoin-qt-setup.exe with a valid
...
that the presidentielcoin-qt.exe file inside the installer had not been tampered with.
