...
class DisableWalletTest (PresidentielcoinTestFramework):
    ...
    def run_test (self):
        # Check regression: https://github.com/presidentielcoin/presidentielcoin2/issues/6963#issuecomment-154548880
