...
from test_framework.util import (start_nodes, start_node, assert_equal, presidentielcoind_processes)
...
class WalletDumpTest(PresidentielcoinTestFramework):
    ...
    def run_test (self):
        ...
        presidentielcoind_processes[0].wait()
