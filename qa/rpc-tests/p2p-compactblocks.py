...
# TestNode: A peer we use to send messages to presidentielcoind, and store responses.
...
class CompactBlocksTest(PresidentielcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes presidentielcoind to (reasonably!) disconnect us, so do this last.
    ...
    # presidentielcoind's choice of nonce.
    ...
    # Test that presidentielcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for presidentielcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # presidentielcoind will not send blocktxn responses for blocks whose height is
