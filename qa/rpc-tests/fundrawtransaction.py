...
class RawTransactionsTest(PresidentielcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid presidentielcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid presidentielcoin address" in e.error['message'])
