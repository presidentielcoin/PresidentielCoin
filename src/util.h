 ...
 */
#ifndef PRESIDENTIELCOIN_UTIL_H
#define PRESIDENTIELCOIN_UTIL_H
...
extern const char * const PRESIDENTIELCOIN_CONF_FILENAME;
extern const char * const PRESIDENTIELCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("presidentielcoin-%s", name);
