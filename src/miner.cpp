...
extern int GetPresidentielcoinDataOutput(const CTransaction& tx);
using namespace std;

//////////////////////////////////////////////////////////////////////////////
//
// PresidentielcoinMiner
//
...
CBlockTemplate* BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    coinbaseTx.vout[0].scriptPubKey = scriptPubKeyIn;
	 // PRESIDENTIELCOIN Compute final coinbase transaction. Add Presidentielcoin dynamic inflation based on service demand
...
void BlockAssembler::AddToBlock(CTxMemPool::txiter iter)
{
	...
	if(iter->GetTx().nVersion == GetPresidentielcoinTxVersion())
	{
		nSysBlockTx++;
		if(nSysBlockTx >= 5)
		{
			int nOut = GetPresidentielcoinDataOutput(iter->GetTx());
			if (nOut != -1)
