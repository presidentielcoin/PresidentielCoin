...
#ifndef PRESIDENTIELCOIN_SCRIPT_SCRIPT_H
#define PRESIDENTIELCOIN_SCRIPT_SCRIPT_H
...
enum opcodetype
{
   ...
   // PRESIDENTIELCOIN aliases
	...
	OP_MESSAGE_ACTIVATE=0x0f,
     ...
     // presidentielcoin extended reserved 
    OP_PRESIDENTIELCOIN_EXTENDED=0x10,
    OP_FALSE = OP_0,
    OP_PUSHDATA1 = 0x4c,
    OP_PUSHDATA2 = 0x4d,
    OP_PUSHDATA4 = 0x4e,
...
public:
    ...
    /**
     * Pre-version-0.6, Presidentielcoin always counted CHECKMULTISIGs
...
#endif // PRESIDENTIELCOIN_SCRIPT_SCRIPT_H
