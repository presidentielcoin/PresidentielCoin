...
{
    RenameThread("presidentielcoin-http");
...
{
    RenameThread("presidentielcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/presidentielcoin/presidentielcoin2/pull/6990)
