...
#ifndef PRESIDENTIELCOIN_MAIN_H
#define PRESIDENTIELCOIN_MAIN_H
...
// PRESIDENTIELCOIN add it here so chain.cpp can access
...
// PRESIDENTIELCOIN for auxpow tests
