...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Presidentielcoin address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"presidentielcoinaddress\"    (string) The new presidentielcoin address\n"
            "\nExamples:\n"
	...
	// PRESIDENTIELCOIN to send v1 address by default
    return CPresidentielcoinAddress(keyID, CChainParams::ADDRESS_OLDSYS).ToString();
}
// PRESIDENTIELCOIN
UniValue getv2address(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
			...
			"\nReturns a new Presidentielcoin (starts with 1) address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
    ...
    return CPresidentielcoinAddress(keyID).ToString();
}
UniValue getzaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"address\"        (string) Presidentielcoin alias or address to convert to ZCash address.\n"
            "\nResult:\n"
    ...
    CPresidentielcoinAddress sysAddress(strAddress);
	...
	if(!sysAddress.vchRedeemScript.empty())
	{
		...
		sysAddress = CPresidentielcoinAddress(innerID, CChainParams::ADDRESS_ZEC);
		return sysAddress.ToString();
	}
	else
	{
		CPubKey pubkey(sysAddress.vchPubKey);
		return CPresidentielcoinAddress(pubkey.GetID(), CChainParams::ADDRESS_ZEC).ToString();
	}
}
CPresidentielcoinAddress GetAccountAddress(string strAccount, bool bForceNew=false)
{
    CPubKey pubKey;
    ...
    return CPresidentielcoinAddress(pubKey.GetID());
}
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Presidentielcoin address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"presidentielcoinaddress\"   (string) The account presidentielcoin address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Presidentielcoin address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"presidentielcoinaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"presidentielcoinaddress\"  (string, required) The presidentielcoin address to be associated with an account.\n"
    ...
    CPresidentielcoinAddress address(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Presidentielcoin address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"presidentielcoinaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"presidentielcoinaddress\"  (string, required) The presidentielcoin address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"presidentielcoinaddress\"  (string) a presidentielcoin address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
    ...
    BOOST_FOREACH(const PAIRTYPE(CPresidentielcoinAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        const CPresidentielcoinAddress& address = item.first;
...
// PRESIDENTIELCOIN: Send service transactions
void SendMoneyPresidentielcoin(const vector<CRecipient> &vecSend, CAmount nValue, bool fSubtractFeeFromAmount, CWalletTx& wtxNew, const CWalletTx* wtxAliasIn=NULL, int nTxOutAlias = 0, bool presidentielcoinMultiSigTx=false, const CCoinControl* coinControl=NULL, const CWalletTx* wtxLinkAliasIn=NULL, int nTxOutLinkAlias = 0)
{
    ...
    std::string strError;
    int nChangePosRet = -1;
    if (!pwalletMain->CreateTransaction(vecSend, wtxNew, reservekey, nFeeRequired, nChangePosRet, strError, coinControl, !presidentielcoinMultiSigTx, wtxAliasIn, nTxOutAlias, true, wtxLinkAliasIn, nTxOutLinkAlias)) {
    ...
    if (!presidentielcoinMultiSigTx && !pwalletMain->CommitTransaction(wtxNew, reservekey))
        throw runtime_error("PRESIDENTIELCOIN_RPC_ERROR ERRCODE: 9000 - " + _("The Presidentielcoin alias you are trying to use for this transaction is invalid or has been updated and not confirmed yet! Please wait a block and try again..."));
}
static void SendMoney(const CTxDestination &address, CAmount nValue, bool fSubtractFeeFromAmount, CWalletTx& wtxNew)
{
    ...
    // Parse Presidentielcoin address
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "sendtoaddress \"presidentielcoinaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"presidentielcoinaddress\"  (string, required) The presidentielcoin address to send to.\n"
            ...
            "                             The recipient will receive less presidentielcoins than you enter in the amount field.\n"
            "\nResult:\n"
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"presidentielcoinaddress\",     (string) The presidentielcoin address\n"
    ...
    BOOST_FOREACH(set<CTxDestination> grouping, pwalletMain->GetAddressGroupings())
    {
        ...
        BOOST_FOREACH(CTxDestination address, grouping)
        {
            ...
            addressInfo.push_back(CPresidentielcoinAddress(address).ToString());
            addressInfo.push_back(ValueFromAmount(balances[address]));
            {
                if (pwalletMain->mapAddressBook.find(CPresidentielcoinAddress(address).Get()) != pwalletMain->mapAddressBook.end())
                    addressInfo.push_back(pwalletMain->mapAddressBook.find(CPresidentielcoinAddress(address).Get())->second.name);
            }
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"presidentielcoinaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"presidentielcoinaddress\"  (string, required) The presidentielcoin address to use for the private key.\n"
    ...
    CPresidentielcoinAddress addr(strAddress);
    if (!addr.IsValid())
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"presidentielcoinaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given presidentielcoinaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"presidentielcoinaddress\"  (string, required) The presidentielcoin address for transactions.\n"
    ...
    // Presidentielcoin address
    CPresidentielcoinAddress address = CPresidentielcoinAddress(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Presidentielcoin address");
	// PRESIDENTIELCOIN
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"topresidentielcoinaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a presidentielcoin address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"topresidentielcoinaddress\"  (string, required) The presidentielcoin address to send funds to.\n"
    ...
    string strAccount = AccountFromValue(params[0]);
    CPresidentielcoinAddress address(params[1].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Presidentielcoin address");
    CAmount nAmount = AmountFromValue(params[2]);
    if (nAmount <= 0)
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The presidentielcoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less presidentielcoins than you enter in their corresponding amount field.\n"
    ...
    set<CPresidentielcoinAddress> setAddress;
    vector<CRecipient> vecSend;
    ...
    {
        CPresidentielcoinAddress address(name_);
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Presidentielcoin address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a Presidentielcoin address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of presidentielcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) presidentielcoin address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"presidentielcoinaddress\"  (string) A presidentielcoin address associated with the keys.\n"
    ...
    return CPresidentielcoinAddress(innerID).ToString();
}
...
UniValue addwitnessaddress(const UniValue& params, bool fHelp)
{
    ...
    return CPresidentielcoinAddress(w.result).ToString();
}
...
UniValue ListReceived(const UniValue& params, bool fByAccounts)
{
    ...
    // Tally
    map<CPresidentielcoinAddress, tallyitem> mapTally;
    for (map<uint256, CWalletTx>::iterator it = pwalletMain->mapWallet.begin(); it != pwalletMain->mapWallet.end(); ++it)
    {
        const CWalletTx& wtx = (*it).second;
    ...
    BOOST_FOREACH(const PAIRTYPE(CPresidentielcoinAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        ...
        map<CPresidentielcoinAddress, tallyitem>::iterator it = mapTally.find(address);
        ...
        {
			// PRESIDENTIELCOIN v1 addy by default
			CTxDestination dest = address.Get();
			CPresidentielcoinAddress v1addr;
...
{
	// PRESIDENTIELCOIN address is v1 address by default for backward compatibility, v2 address is new scheme
    CPresidentielcoinAddress addr;
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"presidentielcoinaddress\",    (string) The presidentielcoin address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"presidentielcoinaddress\",    (string) The presidentielcoin address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"presidentielcoinaddress\",   (string) The presidentielcoin address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending presidentielcoins\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending presidentielcoin\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"presidentielcoinaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; Presidentielcoin server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending presidentielcoins.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of presidentielcoin addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) presidentielcoin address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the presidentielcoin address\n"
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            CPresidentielcoinAddress address(input.get_str());
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Presidentielcoin address: ")+input.get_str());
            if (setAddress.count(address))
    ...
    BOOST_FOREACH(const COutput& out, vecOutputs) {
        ...
        if (fValidAddress) {
			...
			entry.push_back(Pair("v2address", CPresidentielcoinAddress(address).ToString()));
...
UniValue fundrawtransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"     (string, optional, default pool address) The presidentielcoin address to receive the change\n"
    ...
    if (params.size() > 1) {
      if (params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            CPresidentielcoinAddress address(options["changeAddress"].get_str());

            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid presidentielcoin address");
...
// PRESIDENTIELCOIN service rpc functions
...
extern UniValue presidentielcoinsignrawtransaction(const UniValue& params, bool fHelp);
extern UniValue presidentielcoindecoderawtransaction(const UniValue& params, bool fHelp);
...
{ //  category              name                        actor (function)           okSafeMode
	...
	// PRESIDENTIELCOIN support old/new prc and zec
	{ "wallet",             "getv2address",           &getv2address,          true  },
	{ "wallet",             "getzaddress",            &getzaddress,           true  },
	// PRESIDENTIELCOIN rpc functions
	...
	{ "wallet", "presidentielcoinsignrawtransaction",		 &presidentielcoinsignrawtransaction,	false },
	{ "wallet", "presidentielcoindecoderawtransaction",		 &presidentielcoindecoderawtransaction,	false },
