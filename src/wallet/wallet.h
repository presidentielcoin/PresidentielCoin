...
#ifndef PRESIDENTIELCOIN_WALLET_WALLET_H
#define PRESIDENTIELCOIN_WALLET_WALLET_H
...
// PRESIDENTIELCOIN remove cmerkletx
...
// PRESIDENTIELCOIN set to 1 as when services are stored in db they should be usable
...
public:
	...
	// PRESIDENTIELCOIN add data and input tx for presidentielcoin service calls
...
#endif // PRESIDENTIELCOIN_WALLET_WALLET_H
