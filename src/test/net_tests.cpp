// Copyright (c) 2012-2016 The Presidentielcoin Core developers
...
BOOST_AUTO_TEST_CASE(caddrdb_read)
{
    ...
    CService addr1 = CService("250.7.1.1", 62931);
    CService addr2 = CService("250.7.2.2", 9999);
    CService addr3 = CService("250.7.3.3", 9999);

    // Add three addresses to new table.
    addrmanUncorrupted.Add(CAddress(addr1, NODE_NONE), CService("252.5.1.1", 62931));
    addrmanUncorrupted.Add(CAddress(addr2, NODE_NONE), CService("252.5.1.1", 62931));
    addrmanUncorrupted.Add(CAddress(addr3, NODE_NONE), CService("252.5.1.1", 62931));
