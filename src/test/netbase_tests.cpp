...
{
    BOOST_CHECK(TestSplitHost("www.presidentielcoin.org", "www.presidentielcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.presidentielcoin.org]", "www.presidentielcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.presidentielcoin.org:80", "www.presidentielcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.presidentielcoin.org]:80", "www.presidentielcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:62931", "127.0.0.1", 62931));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:62931", "127.0.0.1", 62931));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:62931", "::ffff:127.0.0.1", 62931));
    BOOST_CHECK(TestSplitHost("[::]:62931", "::", 62931));
    BOOST_CHECK(TestSplitHost("::62931", "::62931", -1));
    BOOST_CHECK(TestSplitHost(":62931", "", 62931));
    BOOST_CHECK(TestSplitHost("[]:62931", "", 62931));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:62931", "127.0.0.1:62931"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:62931", "[::]:62931"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
