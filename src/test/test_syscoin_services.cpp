#include "test_presidentielcoin_services.h"
#include "utiltime.h"
#include "util.h"
#include "amount.h"
...
// PRESIDENTIELCOIN testing setup
void StartNodes()
{
...
void StartNode(const string &dataDir, bool regTest, const string& extraArgs)
{
    ...
    boost::filesystem::path fpath = boost::filesystem::system_complete("../presidentielcoind");
...
{
	UniValue val;
	boost::filesystem::path fpath = boost::filesystem::system_complete("../presidentielcoin-cli");
...
{
	string data = "{\\\"rates\\\":[{\\\"currency\\\":\\\"USD\\\",\\\"rate\\\":2690.1,\\\"precision\\\":2},{\\\"currency\\\":\\\"EUR\\\",\\\"rate\\\":2695.2,\\\"precision\\\":2},{\\\"currency\\\":\\\"GBP\\\",\\\"rate\\\":2697.3,\\\"precision\\\":2},{\\\"currency\\\":\\\"CAD\\\",\\\"rate\\\":2698.0,\\\"precision\\\":2},{\\\"currency\\\":\\\"BTC\\\",\\\"rate\\\":100000.0,\\\"fee\\\":75,\\\"escrowfee\\\":0.01,\\\"precision\\\":8},{\\\"currency\\\":\\\"ZEC\\\",\\\"rate\\\":1000000.0,\\\"fee\\\":50,\\\"escrowfee\\\":0.01,\\\"precision\\\":8},{\\\"currency\\\":\\\"PRC\\\",\\\"rate\\\":1.0,\\\"fee\\\":1000,\\\"escrowfee\\\":0.005,\\\"precision\\\":2}]}";
...
BasicPresidentielcoinTestingSetup::BasicPresidentielcoinTestingSetup()
{
}
BasicPresidentielcoinTestingSetup::~BasicPresidentielcoinTestingSetup()
{
}
PresidentielcoinTestingSetup::PresidentielcoinTestingSetup()
{
	StartNodes();
}
PresidentielcoinTestingSetup::~PresidentielcoinTestingSetup()
...
PresidentielcoinMainNetSetup::PresidentielcoinMainNetSetup()
{
	StartMainNetNodes();
}
PresidentielcoinMainNetSetup::~PresidentielcoinMainNetSetup()
