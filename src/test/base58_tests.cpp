...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    std::vector<unsigned char> result;
    CPresidentielcoinSecret secret;
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CPresidentielcoinSecret::SetString tests isValid, whereas CPresidentielcoinAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        else
        {
            ...
            CPresidentielcoinAddress addrOut;
    ...
    CPresidentielcoinAddress dummyAddr;
