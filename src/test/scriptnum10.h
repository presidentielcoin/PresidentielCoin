...
#ifndef PRESIDENTIELCOIN_TEST_SCRIPTNUM10_H
#define PRESIDENTIELCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Presidentielcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PRESIDENTIELCOIN_TEST_BIGNUM_H
