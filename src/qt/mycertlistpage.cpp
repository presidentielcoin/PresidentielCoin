    ...
    optionsModel(0)
{
    ...
    ui->labelExplanation->setText(tr("These are your registered Presidentielcoin Certificates. Certificate operations (create, update, transfer) take 2-5 minutes to become active.  You can choose which aliases to view related certificates using the dropdown to the right."));
