	...
	offerView(parent)
{
    ...
    ui->labelExplanation->setText(tr("Search for Presidentielcoin Offers (double click on one to purchase). Select Safe Search from wallet options if you wish to omit potentially offensive Offers(On by default)"));
...
void OfferListPage::on_purchaseButton_clicked()
{
	...
	QString URI = QString("presidentielcoin://") + offerGUID;
    SendCoinsRecipient recipient;
    if (GUIUtil::parsePresidentielcoinURI(URI, &recipient))
