...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", PresidentielcoinUnits::PRC);
    ...
    if (!settings.contains("zecEndPoint"))
		settings.setValue("zecEndPoint", "http://zec.presidentielcoin.org:8080/");
    if (!settings.contains("btcEndPoint"))
        settings.setValue("btcEndPoint", "http://btc.presidentielcoin.org:8080/");
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/presidentielcoin/presidentielcoin2/pull/8273
