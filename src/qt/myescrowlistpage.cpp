	...
	platformStyle(platformStyle)
{
    ...
    ui->labelExplanation->setText(tr("These are your registered Presidentielcoin Escrows. Escrow operations (create, release, refund, complete) take 2-5 minutes to become active. You can choose which aliases to view related escrows using the dropdown to the right."));
...
void MyEscrowListPage::on_ackButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm Escrow Acknowledgement"),
         tr("Warning: You are about to acknowledge this payment from the buyer. If you are shipping an item, please communicate a tracking number to the buyer via a Presidentielcoin message.") + "<br><br>" + tr("Are you sure you wish to acknowledge this payment?"),
