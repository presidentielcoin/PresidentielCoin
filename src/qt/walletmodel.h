...
#ifndef PRESIDENTIELCOIN_QT_WALLETMODEL_H
#define PRESIDENTIELCOIN_QT_WALLETMODEL_H
...
/** Interface to Presidentielcoin wallet from Qt view code. */
...
#endif // PRESIDENTIELCOIN_QT_WALLETMODEL_H
