	...
	platformStyle(platformStyle)
{
    ...
    ui->labelExplanation->setText(tr("These are your registered Presidentielcoin Offers. Offer operations (create, update) take 2-5 minutes to become active. You can choose which aliases to view related offers using the dropdown to the right."));
