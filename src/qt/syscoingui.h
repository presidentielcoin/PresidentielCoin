...
#ifndef PRESIDENTIELCOIN_QT_PRESIDENTIELCOINGUI_H
#define PRESIDENTIELCOIN_QT_PRESIDENTIELCOINGUI_H
...
/**
  Presidentielcoin GUI main class. This class represents the main window of the Presidentielcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PresidentielcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PresidentielcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PresidentielcoinGUI();
...
#endif // PRESIDENTIELCOIN_QT_PRESIDENTIELCOINGUI_H
