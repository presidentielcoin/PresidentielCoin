/*
 * Presidentielcoin Developers 2014
 */
	...
	platformStyle(platformStyle)
{
    ...
    ui->labelExplanation->setText(tr("These are your registered Presidentielcoin Aliases. Alias operations (create, update, transfer) take 2-5 minutes to become active."));
