...
#ifndef PRESIDENTIELCOIN_QT_WALLETFRAME_H
#define PRESIDENTIELCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, PresidentielcoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // PRESIDENTIELCOIN_QT_WALLETFRAME_H
