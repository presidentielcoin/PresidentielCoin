...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPresidentielcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PresidentielcoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPresidentielcoinURI(info));
}
