...
#ifndef PRESIDENTIELCOIN_QT_SENDCOINSDIALOG_H
#define PRESIDENTIELCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending presidentielcoins */
...
#endif // PRESIDENTIELCOIN_QT_SENDCOINSDIALOG_H
