	...
	currentPage(0)
{
    ...
    ui->labelExplanation->setText(tr("Search for Presidentielcoin Certificates. Select Safe Search from wallet options if you wish to omit potentially offensive Certificates(On by default)"));
