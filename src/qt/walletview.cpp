...
void WalletView::setPresidentielcoinGUI(PresidentielcoinGUI *gui)
{
    if (gui)
    {
		...
		// PRESIDENTIELCOIN
		aliasView->setPresidentielcoinGUI(gui);
		messageView->setPresidentielcoinGUI(gui);
		escrowView->setPresidentielcoinGUI(gui);
		certView->setPresidentielcoinGUI(gui);
		offerView->setPresidentielcoinGUI(gui);
    }
}
