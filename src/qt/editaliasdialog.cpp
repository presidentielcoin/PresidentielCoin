    ...
    ui(new Ui::EditAliasDialog), mapper(0), mode(mode), model(0)
{
	...
	ui->transferDisclaimer->setText(QString("<font color='red'>") + tr("Warning: transferring your alias will transfer ownership all of your presidentielcoin services that use this alias.") + QString("</font>"));
    ...
    if(!saveCurrentRow())
    {
        ...
        case AliasTableModel::INVALID_ALIAS:
            QMessageBox::warning(this, windowTitle(),
				tr("The entered alias is not a valid Presidentielcoin alias. Alias: ") + ui->aliasEdit->text(),
                QMessageBox::Ok, QMessageBox::Ok);
            break;
