...
This document provides guidelines for internationalization of the Presidentielcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `presidentielcoin_en.ts` remains unchanged.
