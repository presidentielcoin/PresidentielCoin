Presidentielcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/presidentielcoin/files/Presidentielcoin/presidentielcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Presidentielcoin
...
New/changed settings (command-line or presidentielcoin.conf file)
--------------------------------------------------------
