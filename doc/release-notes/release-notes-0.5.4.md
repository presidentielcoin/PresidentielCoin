Presidentielcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/presidentielcoin/files/Presidentielcoin/presidentielcoin-0.5.4/
...
http://gitorious.org/presidentielcoin/presidentielcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Presidentielcoin-Qt notifications under Growl 1.3.
Increase required age of Presidentielcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPresidentielcoin properly when installing Presidentielcoin-Qt over it. (Windows)
