Presidentielcoin Core version 0.9.4 is now available from:

  https://presidentielcoin.org/bin/0.9.4/
...
this update is incompatible with the Presidentielcoin system and could lead to consensus
forks.

Presidentielcoin Core released binaries from https://presidentielcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Presidentielcoin Core

upgrade to Presidentielcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
