Presidentielcoin Core version 0.10.4 is now available from:

  <https://presidentielcoin.org/bin/presidentielcoin-core-0.10.4/>
...
- #6953 `43c2789` Split presidentielcoin-tx into its own package
- #6953 `dfe0d4d` Include presidentielcoin-tx binary on Debian/Ubuntu
