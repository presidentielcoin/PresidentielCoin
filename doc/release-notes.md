Presidentielcoin Core version 0.13.2 is now available from:

  <https://presidentielcoin.org/bin/presidentielcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update presidentielcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow presidentielcoin-tx to create v2 transactions (sysdrak)
